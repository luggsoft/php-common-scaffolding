...
final class EditorDirectiveHtmlTemplateProviderEntry extends TemplateProviderEntryBase
{
    ...
    public function getApplicability($values): int
    {
        ...
        if ($values->entity instanceof EntityInterface) {
            if ($values->directive === 'editor' && $values->type === 'html') {
                $total += 10;
            }
        }
            ...
            <div class="clearfix">
                ...
                <?php foreach ($entity->getProperties() as $property): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="<?= $singleFieldPropertyName ?>" ng-model="self.<?= $singleFieldEntityName ?>.<?= $singleFieldPropertyName ?>" />
                    </div>
