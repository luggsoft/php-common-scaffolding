...
final class EditorDirectiveCtrlTemplateProviderEntry extends TemplateProviderEntryBase
{
    ...
    public function getApplicability($values): int
    {
        ...
        if ($values->entity instanceof EntityInterface) {
            if ($values->directive === 'editor' && $values->type === 'ctrl') {
                $total += 10;
            }
        }
    ...
    public function getTemplate($values): TemplateInterface
    {
        return new DelegateTemplate(function () use ($values) {
            ...
            (() => {
                ...
                angular.module('cruddy').directive('<?= $singleFieldEntityName ?>Editor', [directiveFactory]);
                ...
                function directiveFactory() {
                    return _.defaults(this, {
                        ...
                        templateUrl: 'src/cruddy/directives/<?= $singleFieldEntityName ?>Editor/<?= $singleFieldEntityName ?>Editor.html',
